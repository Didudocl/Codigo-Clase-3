...
import { createUserService, getUserService, deleteUserService, updateUserService,  getUsersService  } from '../services/user.service.js';
...
export async function deleteUser(req, res) {
    try {
        ...
        const userDeleted = await deleteUserService(id, userFound);
